(function() {
    ...
    angular.module('app.components')
        .factory('experimenterSrv', ['Restangular', '$log', 'experimenterCommunityAPI', 'alert', experimenterSrv]);

    function experimenterSrv(Restangular, $log, experimenterCommunityAPI, alert) {
        ...
        function loadCommunities(success_, fail_) {
            experimenterCommunityAPI.getCommunities(success, fail);
        ...
        function updateExperiment(info, success_, fail_) {
            experimenterCommunityAPI.updateExperiment(info.experimentId, info, success, fail);
        ...
        function removeCommunity(id, success_, fail_) {
            experimenterCommunityAPI.removeCommunity(id, success, fail);
        ...
        function leaveExperiment(experId,  expId, success_, fail_) {
            experimenterCommunityAPI.leaveExperiment(experId,  expId, success, fail);
