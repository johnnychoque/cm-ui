(function() {
    ...
    angular.module('app.components')
        .factory('siteCommunityAPI', ['$log', 'Restangular', siteCommunityAPI]);


    function siteCommunityAPI($log, Restangular) {
        ...
        function getCommunities(id, success_, fail_) {
            var path = 'community/site/' + id;
